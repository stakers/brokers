 ...
 */
@RestController
@RequestMapping(value = "/ancilliary")
public class AncilliaryController {

	final static org.slf4j.Logger LOGGER = LoggerFactory.getLogger(AncilliaryController.class);
	@Autowired
	AncilliaryService service;
	@Autowired
